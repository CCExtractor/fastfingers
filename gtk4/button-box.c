...
void back_click_cb(GtkGestureClick *gesture, gint n_press, gdouble x, gdouble y,
                   GtkWidget *widget) {
  ff_switch_previous();
}

void settings_click_cb(GtkGestureClick *gesture, gint n_press, gdouble x,
                       gdouble y, GtkWidget *widget) {
